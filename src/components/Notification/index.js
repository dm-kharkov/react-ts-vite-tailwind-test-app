...
import { getCloseButtonClasses, getNotifyTypeClasses } from 'lib/notification';
import './styles.scss';
const Notification = (props) => {
    const { message, onClose, type = NOTIFICATION_TYPES.SUCCESS } = props;
    ...
    return (React.createElement("div", { className: clsx([
        ...
        React.createElement("svg", { className: 'flex-shrink-0 w-4 h-4', "aria-hidden": 'true', xmlns: 'http://www.w3.org/2000/svg', fill: 'currentColor', viewBox: '0 0 20 20' },
        ...
        React.createElement("p", { className: 'ms-3 text-sm font-medium' }, message),
        React.createElement("button", { type: 'button', className: clsx([
            ...
            React.createElement("span", { className: 'sr-only' }, "Close alert"),
