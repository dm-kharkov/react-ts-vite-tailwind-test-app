...
const DiscountCodeGeneration = (props) => {
    const { label = DEFAULT_LABEL, setDiscountCode } = props;
    ...
    return (React.createElement("button", { type: 'button', className: clsx([
        ...
        ]), disabled: isSelectedType, onClick: handleClick }, label));
};
